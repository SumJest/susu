...
f = open("lab6/input.txt", "r")  # здесь мы открываем файл "input.txt"
...
for line in f.readlines():  # чтение построчно
    print(line.rstrip())  # выведите каждую строку *** Так же необходимо убрать \n в конце строки командой rstrip()
    f.close()  # Важно закрыть файл, чтобы освободить системные ресурсы.

f1 = open("lab6/input1.txt", "r")
...
if __name__ == "__main__":
    f = open("lab6/output.txt", "a")  # добавьте нужный аргумент
